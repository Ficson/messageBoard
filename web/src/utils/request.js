...
request.interceptors.response.use(
  ...
  error => {
    if (error.toString() === 'Error: Network Error' || error.toString().indexOf('Error: timeout') > -1) {
...
export const aget = ({url = '', params = {}, opts = {}} = {}) => request.get(url, Object.assign({}, {params}, opts))
export const apost = ({url = '', data = {}, params = {}, opts = {}, isqs = false} = {}) => {
